#############################################################################
# Makefile for building: Boderculator
# Generated by qmake (3.1) (Qt 5.15.15)
# Project:  project_file.pro
# Template: app
# Command: /sbin/qmake -o Makefile project_file.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Boderculator1.0.0
DISTDIR = /home/mod/CODE/Boderculator/.tmp/Boderculator1.0.0
LINK          = g++
...
OBJECTS       = main.o \
		GraphingCalculator.o \
		NumericalCalculator.o
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		project_file.pro GraphingCalculator.h \
		NumericalCalculator.h main.cpp \
		GraphingCalculator.cpp \
		NumericalCalculator.cpp
QMAKE_TARGET  = Boderculator
DESTDIR       = 
TARGET        = Boderculator
...
Boderculator:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: project_file.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		project_file.pro
	$(QMAKE) -o Makefile project_file.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents GraphingCalculator.h NumericalCalculator.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp GraphingCalculator.cpp NumericalCalculator.cpp $(DISTDIR)/
...
main.o: main.cpp NumericalCalculator.h \
		GraphingCalculator.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

GraphingCalculator.o: GraphingCalculator.cpp GraphingCalculator.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o GraphingCalculator.o GraphingCalculator.cpp

NumericalCalculator.o: NumericalCalculator.cpp NumericalCalculator.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o NumericalCalculator.o NumericalCalculator.cpp
